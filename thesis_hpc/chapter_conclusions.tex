...
From the neuron file 12 parameters are used by the simulation.
It contains further parameters which are used for the connection generation and the visualization,
like coordinates. In total the neuron file is of the size of around 9 GB.
...
All in all, the generated circuit contains around 16 TB of data and is splitted in three HDF5
...
The critical part of the implementation is the IO, because the number of created synapses is not know in the beginning.
