...
\begin{axis}[
    ...
    xmax=160,
    xlabel={iteration},
    ylabel={used memory* per node [MB]},
    grid=major,
...
\addplot[very thin,mark=none, color=red] plot coordinates {(140,14686.013672) (160,16770.000000)}; \addlegendentry{theoretical}
...
\addplot[mark=none, color=black] plot coordinates {(0,16100) (160,16100)};
