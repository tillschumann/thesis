   	...
   	\end{center}
    	\caption[Illustration of the given experiments and the projection image of an example experiment]{%
         Illustration of the given experiments and the projection image of an example experiment.
   		 It gives an insight into the synaptic structure of the whole brain. (a) shows 
   		 injections sites of all available experiments. (b) shows the projection for one injection
   		 experiment.
   		  The colors are
