...
The program execution takes around around half an hour on the Blue Brain IV using 256 processes for the full circuit.
...
\begin{figure}[ht!]
     \begin{center}
        \subfigure[]{%
            \label{fig:sim1}
            %\includegraphics[scale=0.41]{pictures/histogram_new_const_1_300.eps}
            \includegraphics[scale=0.11]{pictures/vlcsnap-2016-02-19-23h32m46s97.png}
        }
        \subfigure[]{%
           \label{fig:sim2}
           %\includegraphics[scale=0.41]{pictures/t8_duration_per_con_1_300.eps}
           \includegraphics[scale=0.11]{pictures/vlcsnap-2016-02-19-23h32m58s247.png}
		}
		\subfigure[]{%
           \label{fig:sim2}
           %\includegraphics[scale=0.41]{pictures/t8_duration_per_con_1_300.eps}
           \includegraphics[scale=0.11]{pictures/vlcsnap-2016-02-19-23h33m05s74.png}
		}
		\subfigure[]{%
           \label{fig:sim2}
           %\includegraphics[scale=0.41]{pictures/t8_duration_per_con_1_300.eps}
           \includegraphics[scale=0.11]{pictures/vlcsnap-2016-02-19-23h33m26s6.png}
		}
    \end{center}
    \caption{%
