...
\begin{algorithm}
	...
	\While{Chunk to read in HDF5 files}{
		...
		Create list of synapses [[$S_1$, $T_1$, $P_{1,1}$, $P_{2,1}$, ..,$P_{m,1}$],[$S_2$, $T_2$, $P_{1,1}$, $P_{2,2}$, ..,$P_{m,2}$],..] (1,2) \hspace{36px}$\mathcal{O}(n)$\; 
		...
		MPI\_Alltoall using sorted list \hspace{76px}(2,3,4,5)\;
